...
<?php
    ...
    create_log_action($_SESSION['user_id'], $action_msg); 
		...
		echo'<meta http-equiv="refresh" content="0;url='.BASEURL.'product/categories">';
	  ...
	  $db->orderBy('id','ASC');
	  $results = $db->get("product_category"); ?>
			...
			<div class="padding-md clearfix">
				<?php if($results): ?>
		            ...
		            <tr>
		              ...
		              $i++;
								...
								<tr>
									...
									<td><?= $res['title']; ?></td>
		              <td>
		                <a href="product/categories/<?=$res['id'];?>" title="Edit" class="btn btn-primary btn-sm tooltip-test" data-toggle="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>
		              </td>
								</tr>
								<?php endforeach ?>
							</tbody>
					...
					<div class="col-lg-8 col-md-8 col-sm-12">
						<h3 class="headline m-top-md">
								<?= $edit ? '<div class="float-left">Edit:</div><div class="float-right"><a href="product/categories" class="btn btn-primary btn-sm">Add New</a></div>' : '<div>Add New: </div>'; ?>
								<div class="clear"></div>
								<span class="line"></span>
						</h3>
						<form id="formToggleLine" class="form-horizontal no-margin form-border" name="" action="product/categories<?= isset($_GET['id']) ? '/'.$_GET['id'] : '';?>" method="POST">
							<?= $form->text_field('title', 'Category',$edit ? $category['title'] : ''); ?>
